...
public class PersistenceHelper {
	...
	public <T> Long getVersion(Class<T> clazz, Object id) {
		TypedQuery<Long> query = entityManager.createQuery("SELECT version FROM " + clazz.getSimpleName() + " WHERE id = :id", Long.class);
